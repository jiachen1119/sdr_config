...
#ifndef SDR_CONFIG_MYQCHART_H
#define SDR_CONFIG_MYQCHART_H
...
class myQchart :public QObject{
    Q_OBJECT
public:
    explicit myQchart(QPointer<QCustomPlot> _parentPlot, PlotValueTracerType _type,QCPGraph *_graph = 0);
    ~myQchart() override;
...
private:
    ...
    QVector<double> CNo_data;
};


#endif //SDR_CONFIG_MYQCHART_H
